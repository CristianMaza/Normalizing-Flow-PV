...
if tag == 'pv':
    ...
    data, indices = pv_data(path_name='df_pv-filled-hourly.csv', test_size=50, random_state=0)
    ylim_loss = [-50, 50]
    ymax_plf = 2
    ylim_crps = [0, 10]
    nb_zones = 3
    ...
    data = wind_data(path_name='df_pv-filled-hourly.csv', test_size=50, random_state=0)
    ylim_loss = [0, 40]
    ymax_plf = 8
    ylim_crps = [6, 12]
    nb_zones = 10
    ...
    data = load_data(path_name='df_load.csv', test_size=50, random_state=0)
    ylim_loss = [-50, 50]
    ymax_plf = 2
    ylim_crps = [0, 10]
    nb_zones = 1
